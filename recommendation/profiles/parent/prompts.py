...
- required_education.levels.level_key MUST be one of: secondary, higher_secondary_11, higher_secondary, diploma, graduation, post_graduation, doctorate, professional, certification
...
def format_parent_prompt_inputs(
    *, parent_assessment: dict[str, Any], validation_feedback: str = "None"
) -> dict[str, str]:
    mode = (
    ...
    return format_inputs(
        "parent_assessment", parent_assessment, mode, validation_feedback
    )
