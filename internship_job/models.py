...
class Internship(BaseModule):
    ...
    internship_overview = models.TextField(
        null=True,
        blank=True,
    ...
    application_deadline = models.DateField(
        null=True, blank=True, help_text="Application deadline date"
    )
    status = models.CharField(
        max_length=100, choices=INTERNSHIP_STATUS_CHOICE, default="draft"
    )
...
class Job(BaseModule):
    ...
    why_this_match = models.TextField(null=True, blank=True)
    status = models.CharField(
        max_length=100, choices=JOB_STATUS_CHOICE, default="draft"
    )
    application_deadline = models.DateField(
        null=True, blank=True, help_text="Application deadline date"
    )
