...
class EducationLevel(BaseModule):
    ...
    fallback_insight = models.TextField(blank=True, help_text="Shown when user has insufficient responses for this level")
    fallback_action = models.TextField(blank=True, help_text="Action prompt shown alongside fallback insight")
    next_step_1 = models.TextField(blank=True, help_text="First recommended next step for this level")
    next_step_2 = models.TextField(blank=True, help_text="Second recommended next step for this level")
    next_step_3 = models.TextField(blank=True, help_text="Third recommended next step for this level")
