...
def send_meter_usage_alert_email(device, partner_company, company_name, recent_usage, daily_average, usage_percentage):
    """
    ...
    try:
        ...
        context = {
            ...
            'partner_company_name': device.partner_company.company_name if device.partner_company else None,
        ...
        for recipient_email in recipients:
            try:
                ...
                try:
                    ...
                    logo_path = os.path.join(BASE_DIR, "static/images/e-switch-h-final.png")
                    ...
                    logger.warning(f"Logo attachment failed but email was sent to {recipient_email}: {str(logo_error)}")
                ...
                logger.info(f"Meter usage alert email sent successfully to {recipient_email}")
                
            except Exception as e:
                logger.error(f"Failed to send meter usage alert email to {recipient_email}: {str(e)}")
