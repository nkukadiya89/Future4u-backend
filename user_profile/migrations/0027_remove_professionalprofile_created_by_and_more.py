...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name="professionalprofile",
            index=models.Index(
                fields=["education_level"], name="professiona_educati_2a9a5c_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="professionalprofile",
            index=models.Index(
                fields=["employment_type"], name="professiona_employm_c08cf4_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="professionalprofile",
            index=models.Index(
                fields=["years_of_experience"], name="professiona_years_o_fec609_idx"
            ),
        ),
    ]
