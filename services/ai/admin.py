...
from services.ai.clients.groq_client import get_groq_api_key_optional
from services.ai.config import ai_use_openai
...
from services.ai.models import AIRecommendationPanel
