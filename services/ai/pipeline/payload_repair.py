...
def ensure_why_bullet(text: str) -> str:
    ...
    words = clipped.split()
    from services.ai.schemas.recommendation_output import WHY_CAREER_MIN_WORDS
...
def repair_required_education(
    ...
    from services.ai.schemas.recommendation_output import EDUCATION_SUGGESTION_MIN
