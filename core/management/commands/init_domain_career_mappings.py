...
class Command(BaseCommand):
    help = "Load domain-career mappings from CSV (defaults to core/management/source/domain_career_mapping_sample.csv)."

    def add_arguments(self, parser):
        parser.add_argument(
            "--path",
            dest="load_path",
            default=str(Path(settings.BASE_DIR) / "core" / "management" / "source" / "domain_career_mapping_sample.csv"),
