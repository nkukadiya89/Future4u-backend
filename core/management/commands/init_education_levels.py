...
class Command(BaseCommand):
    help = "Write sample education-level CSV and/or load education levels from CSV."

    def add_arguments(self, parser):
        parser.add_argument(
            "--sample-path",
            default=str(Path(settings.BASE_DIR) / "core" / "management" / "source" / "education_level_master_sample.csv"),
