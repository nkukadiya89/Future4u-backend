...
urlpatterns = [
    path(
        ...
        views.cart_add_to_cart,
        name="subscription-cart-add",
    ),
    ...
    path(
        ...
        name="subscription-cart-increment",
    ),
    path(
        "subscription-cart/decrement/",
        views.cart_decrement,
        name="subscription-cart-decrement",
    ),
    path(
        "subscription-cart/<int:pk>/remove/",
        views.cart_remove,
        name="subscription-cart-remove",
    ),
    path(
        "subscription-cart/checkout/",
        views.cart_checkout,
        name="subscription-cart-checkout",
    ),
]
